...
```{r principle components by language (maps), fig.height = 6, fig.width = 10}
ggplot(d.pca.demo) +   
...
```{r model fits with PCA for demo, fig.width=10, fig.height = 14}
...
```{r PCA with language variables (lmer), fig.width=10, fig.height = 8}
